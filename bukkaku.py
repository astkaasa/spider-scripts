...
#         item["images"] = {}
        ...
        for image_index, image in enumerate(images):
            ...
            os.system(f"wget -o /dev/null -qO '/home/ubuntu/data/images/{size_line_station}/{name}/{image_name}_{image_index}.jpg' '{image_url}'")
